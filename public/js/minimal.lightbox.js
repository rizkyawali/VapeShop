...
function minimalLightbox() {
	...
	displayImage.setAttribute('style','position: fixed; left: 28%; top: 25%; width: 600px; height: 300px; background-image: url("' + imageSelect + '");  background-size: contain; background-position: center center; background-repeat: no-repeat;');
